...
resource "aws_s3_bucket_public_access_block" "s3_public_access_block" {
  ...
  block_public_acls       = var.enable_public_block
  block_public_policy     = var.enable_public_block
  ignore_public_acls      = var.enable_public_block
  restrict_public_buckets = var.enable_public_block
}
